...
import model.DAO.AnimalDAOImpl;
...
public class RegraAnimal {
    ...
    public void validarIdCliente(int codigoCliente) throws RegraExceptionAnimal{
        if (codigoCliente == 0){
            throw new  RegraExceptionAnimal("Numero do documento do cliente não consta no sistema, favor cadastrar o cliente ou alterar o numero do documento.");
        }
    }
