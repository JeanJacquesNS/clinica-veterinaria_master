...
import controller.ControllerAutenticacao;
...
public class TelaFuncionario extends javax.swing.JFrame {
    ...
    private void btnCadastrarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarFuncionarioActionPerformed
        ...
        ControllerFuncionario controllerFunc = new ControllerFuncionario();
        ControllerAutenticacao controllerAutenticacao = new ControllerAutenticacao();
        ...
        if(acao == 1){
            try{
                controllerFunc.cadastrarFuncionario(func);
                controllerAutenticacao.inserirCredenciais(autenticacao);
        ...
        if(acao == 2){
            ...
            try {
                controllerFunc.alterarFuncionario(func);
            } catch (RegraExceptionFuncionario ex) {
    ...
    private void jButtonDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeletarActionPerformed
        ...
        ControllerFuncionario controllerFunc = new ControllerFuncionario();
        try {
            controllerFunc.deletarFuncionario(Integer.parseInt(txtId.getText()));
        } catch (RegraExceptionFuncionario ex) {
    ...
    private void jTableFuncMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableFuncMouseClicked
        ...
        try{
            Funcionario funcionario = controllerFuncionario.consultarFuncionario(nrDocumento);
    ...
    public void preencherTabela(){
        ...
        try {
            listaFuncionario = controllerFuncionario.listarFuncionarios();
