...
public class TelaChangePassword extends javax.swing.JFrame {
    ...
    public static String nrDocumento;

    /**
     * Creates new form NewJFrame
     * @param nrDocumento
     */
    public TelaChangePassword(String nrDocumento) {
        initComponents();
    ...
    private void txtAlterarSenhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtAlterarSenhaActionPerformed
        ...
        try {
            if(newPass.equals(confirmPass)){
                controllerAutenticacao.alterarSenha(oldPassp, newPass, nrDocumento);
                new TelaPrincipal(nrDocumento).setVisible(true);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaChangePassword(nrDocumento).setVisible(true);
            }
        });
    }
