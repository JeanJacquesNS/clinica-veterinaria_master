...
import controller.ControllerTratamento;
...
public class TelaTratamento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btbCadastrarTramento.setBackground(new java.awt.Color(0, 153, 0));
        btbCadastrarTramento.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btbCadastrarTramento.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void btbCadastrarTramentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btbCadastrarTramentoActionPerformed
        ...
        */
        ControllerTratamento controllerTrat = new ControllerTratamento();
        /**
        * Try Catch para agendar um exame.
        */
         try{
            controllerTrat.inserirTratamento(tratamento);
